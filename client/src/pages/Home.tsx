          ...
          <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in-up">
            ...
            <div className="grid sm:grid-cols-2 gap-6 md:gap-8 mt-12">
              <div className="p-6 rounded-xl bg-background border border-border hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">USD mensuales generados con nuestra agencia SAAS aplicando estas mismas estrategias</p>
              </div>
              <div className="p-6 rounded-xl bg-background border border-border hover:border-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">Garantía de satisfacción. Si no te gusta, te devolvemos tu inversión</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="border-primary text-primary hover:bg-primary/10 w-full hover:scale-105 transition-transform"
              >
